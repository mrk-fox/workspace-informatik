...
public class List<ContentType> {
  ...
  public ContentType getBefore() {
	    if (!this.hasAccess() || current == first) {
	        return null; // kein current, oder current ist schon das erste Element
	    }
	    ListNode previous = this.getPrevious(current);
	    if (previous == null) {
	        return null;
	    }
	    return previous.getContentObject();
	}
