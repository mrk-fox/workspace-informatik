/**
 * Benutzungsoberfläche für ein Programm zur Erstellung eines Stichwortregisters
 *
 * @version 30.07.2018
...
public class Buchindex_GUI extends Frame {
  ...
  // Ende Attribute
  private StichwortRegister index;
  ...
  public Buchindex_GUI(String title) {
    ...
    button1.setLabel("Begriff einfügen");
    ...
    index= new StichwortRegister();
  }

  // Anfang Methoden
  public void button1_ActionPerformed(ActionEvent evt) {
    // TODO hier Quelltext einfügen
    index.fuegeEin(textField1.getText(),Integer.parseInt(textField2.getText()));
  }

  public void button2_ActionPerformed(ActionEvent evt) {
    // TODO hier Quelltext einfügen
    index.erzeugeTestdaten();
  }

  public void button3_ActionPerformed(ActionEvent evt) {
    // TODO hier Quelltext einfügen
    textArea1.setText(index.stichwortListe());
  }
